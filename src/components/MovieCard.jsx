...
const MovieCard = ({movie}) => {
  ...
  return (
    <div className='flex flex-col justify-between p-3 bg-gray-800 rounded-3xl overflow-hidden hover:-translate-y-5 transition duration-300 w-66 ring-1 ring-white/10'>
